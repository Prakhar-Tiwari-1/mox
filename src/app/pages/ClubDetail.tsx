  ...
  return (
    <div className="min-h-screen">
      ...
      <section className="py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid lg:grid-cols-[1.2fr,0.8fr] gap-10 items-start">
          ...
          <div className="space-y-6">
              ...
              <CardContent className="space-y-4">
                ...
                {!club.contact_email && !club.contact_phone && (
                  <p className="text-gray-600">
                    Contact details for this club can be added from the backend once club management is enabled.
                  </p>
                )}
              </CardContent>
            </Card>
            ...
            {club.members && club.members.length > 0 && (
              <Card>
                <CardHeader>
                  <CardTitle>Affiliated team</CardTitle>
                </CardHeader>
